...
import '../../App.css';
import { QuestionIcon, SettingsIcon, LinkIcon, ArrowBackIcon } from '@chakra-ui/icons';
      ...
      {user ? ( 
        ...
        <MenuList>
          ...
          <MenuGroup title='Помощь'>
            <MenuItem><Link to="https://github.com/d1amond09"><LinkIcon mr={2}/>GitHub</Link></MenuItem>
